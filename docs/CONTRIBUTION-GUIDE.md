...
> **Panduan lengkap untuk kontributor upstream ke delorenj/mcp-server-trello.**
...
Contributing to `delorenj/mcp-server-trello` adalah strategic decision yang memberikan manfaat:

**Untuk KAEDE Ecosystem:**
...
**Untuk Community:**
- ✅ Share improvements dengan users lain
- ✅ Set standard untuk Trello MCP implementations
...
Sebelum contribute, pahami arsitektur dan code style:
...
Karena KAEDE menggunakan **Vanilla JavaScript + fetch**, sementara TRELLO MCP menggunakan **TypeScript + Axios**, perlu adaptation:
...
**Recommendation:** Option 1 (TypeScript) untuk easier upstream integration.
