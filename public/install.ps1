...
function Write-NextSteps {
  ...
  Write-Host "    kaede init <project>   init project with KAEDE" -ForegroundColor DarkGray
  ...
  Write-Host "    ~/.config/opencode/opencode.json (global MCP)" -ForegroundColor DarkGray
  Write-Host "    ~/.config/kaede/secrets.env" -ForegroundColor DarkGray
  Write-Host ""
}
