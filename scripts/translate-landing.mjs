...
const idToEn = [
  ...
  // === About / Tentang ===
  ['<span class="text-[10px] font-semibold tracking-[0.2em] uppercase text-kaede-primary">Tentang</span>', '<span class="text-[10px] font-semibold tracking-[0.2em] uppercase text-kaede-primary">About</span>'],
  ...
  // === Ecosystem ===
  ['<span class="text-[10px] font-semibold tracking-[0.2em] uppercase text-kaede-primary">Ekosistem</span>', '<span class="text-[10px] font-semibold tracking-[0.2em] uppercase text-kaede-primary">Ecosystem</span>'],
  ['<h2 class="text-3xl sm:text-4xl font-bold mt-2">Empat Pilar Pengembangan Koneksi</h2>', '<h2 class="text-3xl sm:text-4xl font-bold mt-2">Four Pillars of Koneksi Development</h2>'],
  ...
  // How they connect
  ['<h3 class="text-sm font-semibold mb-4">Bagaimana Mereka Terhubung?</h3>', '<h3 class="text-sm font-semibold mb-4">How They Connect?</h3>'],
  ...
  // === OpenKB Section ===
  ['<span class="text-[10px] font-semibold tracking-[0.2em] uppercase text-kaede-success">Protokol</span>', '<span class="text-[10px] font-semibold tracking-[0.2em] uppercase text-kaede-success">Protocol</span>'],
  ['<p class="text-kaede-muted mt-1">Open Knowledge Base — bahasa komunikasi AI ↔ Human</p>', '<p class="text-kaede-muted mt-1">Open Knowledge Base — AI ↔ Human communication language</p>'],
  ...
  ['<h4 class="text-xs font-semibold uppercase tracking-wider text-kaede-muted mb-3">Struktur Direktori</h4>', '<h4 class="text-xs font-semibold uppercase tracking-wider text-kaede-muted mb-3">Directory Structure</h4>'],
  ...
  ['<h4 class="text-xs font-semibold uppercase tracking-wider text-kaede-muted mb-3">Alur Komunikasi</h4>', '<h4 class="text-xs font-semibold uppercase tracking-wider text-kaede-muted mb-3">Communication Flow</h4>'],
  ['<span><strong class="text-kaede-text">AI membaca OpenKB</strong> sebelum membantu — paham konteks, istilah, aturan.</span>', '<span><strong class="text-kaede-text">AI reads OpenKB</strong> before assisting — understands context, terms, rules.</span>'],
  ['<span><strong class="text-kaede-text">Manusia menulis OpenKB</strong> — catat keputusan, update glossary, tambah referensi.</span>', '<span><strong class="text-kaede-text">Humans write OpenKB</strong> — record decisions, update glossary, add references.</span>'],
  ['<span><strong class="text-kaede-text">Dua arah</strong> — AI bisa rekomen update ke OpenKB, manusia review dan approve.</span>', '<span><strong class="text-kaede-text">Bidirectional</strong> — AI can suggest updates to OpenKB, humans review and approve.</span>'],

  // === Playbook Section ===
  ['<span class="text-[10px] font-semibold tracking-[0.2em] uppercase text-kaede-warning">Panduan</span>', '<span class="text-[10px] font-semibold tracking-[0.2em] uppercase text-kaede-warning">Guide</span>'],
  ['<p class="text-kaede-muted mt-1">Standard operasional untuk manusia</p>', '<p class="text-kaede-muted mt-1">Operational standards for humans</p>'],
  ...
  ['<th class="text-left py-2 pr-3 font-semibold text-kaede-text">Aspek</th>', '<th class="text-left py-2 pr-3 font-semibold text-kaede-text">Aspect</th>'],
  ...
  // === OpenCode Section ===
  ['<span class="text-[10px] font-semibold tracking-[0.2em] uppercase text-kaede-primary">Konfigurasi</span>', '<span class="text-[10px] font-semibold tracking-[0.2em] uppercase text-kaede-primary">Configuration</span>'],
  ['<p class="text-kaede-muted mt-1">Konfigurasi AI Agent di setiap repositori</p>', '<p class="text-kaede-muted mt-1">AI Agent configuration per repository</p>'],
  ...
  ['<h4 class="text-xs font-semibold uppercase tracking-wider text-kaede-muted mb-3">Contoh Struktur</h4>', '<h4 class="text-xs font-semibold uppercase tracking-wider text-kaede-muted mb-3">Example Structure</h4>'],
  ...
  ['<h4 class="text-xs font-semibold uppercase tracking-wider text-kaede-muted mb-3">Integrasi dengan KAEDE</h4>', '<h4 class="text-xs font-semibold uppercase tracking-wider text-kaede-muted mb-3">Integration with KAEDE</h4>'],
  ...
  ['<span class="text-[10px] font-semibold tracking-[0.2em] uppercase text-kaede-primary">Workflow</span>', '<span class="text-[10px] font-semibold tracking-[0.2em] uppercase text-kaede-primary">Workflow</span>'],
  ...
  ['<span class="text-[10px] font-medium px-2 py-0.5 rounded bg-kaede-warning/20 text-kaede-warning">Product + BA</span>', '<span class="text-[10px] font-medium px-2 py-0.5 rounded bg-kaede-warning/20 text-kaede-warning">Product + BA</span>'],
  ...
  ['<span class="text-[10px] font-medium px-2 py-0.5 rounded bg-kaede-primary/20 text-kaede-primary">Developer + Agent</span>', '<span class="text-[10px] font-medium px-2 py-0.5 rounded bg-kaede-primary/20 text-kaede-primary">Developer + Agent</span>'],
  ...
  ['<span class="text-[10px] font-medium px-2 py-0.5 rounded bg-kaede-danger/20 text-kaede-danger">Senior (HITL)</span>', '<span class="text-[10px] font-medium px-2 py-0.5 rounded bg-kaede-danger/20 text-kaede-danger">Senior (HITL)</span>'],
  ...
  ['<span class="text-[10px] font-semibold tracking-[0.2em] uppercase text-kaede-primary">Panduan</span>', '<span class="text-[10px] font-semibold tracking-[0.2em] uppercase text-kaede-primary">Guide</span>'],
  ['<h2 class="text-3xl sm:text-4xl font-bold mt-2">Menggunakan KAEDE Power-Up</h2>', '<h2 class="text-3xl sm:text-4xl font-bold mt-2">Using KAEDE Power-Up</h2>'],
  ['Cara menginstall dan memanfaatkan KAEDE di Trello tim Koneksi.', 'How to install and use KAEDE on your Koneksi team Trello.'],
  ['<h3 class="text-sm font-semibold">Install Power-Up</h3>', '<h3 class="text-sm font-semibold">Install Power-Up</h3>'],
  ...
  ['<h3 class="text-sm font-semibold">Aktifkan di Board</h3>', '<h3 class="text-sm font-semibold">Enable on Board</h3>'],
  ...
  ['<h3 class="text-sm font-semibold">Kelola Environment</h3>', '<h3 class="text-sm font-semibold">Manage Environment</h3>'],
  ...
  ['<span class="px-2.5 py-1 rounded bg-kaede-success/20 text-kaede-success">22 Tools</span>', '<span class="px-2.5 py-1 rounded bg-kaede-success/20 text-kaede-success">22 Tools</span>'],
];
